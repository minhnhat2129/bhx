...
with col1:
    ...
    am_chon = st.multiselect("Chọn AM", sorted(ams), default=ams)
...
st.subheader("📈 Doanh thu theo Ngày (line)")
fig3 = px.line(df_filtered, x="Ngày", y="Tổng Doanh thu",
               color="Tên siêu thị", markers=True,
               title="Tổng Doanh thu theo ngày",
               text=df_filtered['Tổng Doanh thu'] / 1_000_000)
fig3.update_traces(texttemplate='%{text:.1f}M', textposition="top center")
fig3.update_yaxes(title="Doanh thu (VND)", tickformat=",.0f")
